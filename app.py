...
def gerar_pdf(numero, d):
    ...
    def bloco(titulo):
        ...
        el.append(Paragraph("Sábado: 09:00–14:00", styles["Normal"]))
        el.append(Paragraph("Domingo: Fechado", styles["Normal"]))
        el.append(Paragraph("Segunda-feira: 09:00–17:30", styles["Normal"]))
        el.append(Paragraph("Terça-feira: 09:00–17:30", styles["Normal"]))
        el.append(Paragraph("Quarta-feira: 09:00–17:30", styles["Normal"]))
